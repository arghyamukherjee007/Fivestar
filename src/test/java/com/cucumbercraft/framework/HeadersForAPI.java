...
public class HeadersForAPI {
	...
	public Map<String, String> getHeaders5() {
		Map<String, String> map = new HashMap<String, String>();
		map.put("Content-Type", "text/xml;charset=utf-8");
		map.put("SOAPAction", "\"http://tempuri.org/IPSSManager/PSSLongSell\"");
		return map;
	}
	
	public Map<String, String> getHeaders6() {
		Map<String, String> map = new HashMap<String, String>();
		map.put("Content-Type", "text/xml;charset=utf-8");
		map.put("SOAPAction", "\"http://tempuri.org/IPSSManager/PSSUpdatePNRsCommand\"");
		return map;
	}
