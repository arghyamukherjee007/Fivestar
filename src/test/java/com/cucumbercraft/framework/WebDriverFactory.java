	...
	public static WebDriver getWebDriver(Browser browser) {
		...
		try {
			...
			case CHROME:
				...
				//Adding path within the Project folder
				File path = new File("/usr/bin/chromedriver");
				//System.setProperty("webdriver.chrome.driver", properties.getProperty("ChromeDriverPath"));
				String chromePath = path.toString();
				ChromeOptions options = new ChromeOptions();
				options.addArguments(Arrays.asList("--headless","--whitelisted-ips","--no-sandbox","--disable-extensions"));
				System.setProperty("webdriver.chrome.driver", chromePath);
				try {
					driver = new ChromeDriver(options);
				} catch (IllegalStateException e) {
					path = new File(Util.getAbsolutePath() + Util.getFileSeparator() + "Drivers"+Util.getFileSeparator() + "chromedriver.exe");
					chromePath = path.toString();
					System.setProperty("webdriver.chrome.driver", chromePath);
			...
			case INTERNET_EXPLORER:
				...
				path = new File(Util.getAbsolutePath() + Util.getFileSeparator() + "Drivers"+Util.getFileSeparator() + "IEDriverServer.exe");
				String IEPath = path.toString();
