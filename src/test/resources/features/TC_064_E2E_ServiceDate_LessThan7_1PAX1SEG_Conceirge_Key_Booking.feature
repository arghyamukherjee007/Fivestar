@Regression @P1Scripts @TC_064ConceirgeKeyBooking
Feature: ConceirgeKey Booking
   Initiate a ConciergeKey booking and perform all the validations

  @TC_064ConceirgeKeyBookingScenario1
  Scenario Outline:  Two airports should be selected with service date less than 7 days and Transportation details (Domestic and International phone numbers) should be entered 
    ...
    When Booking completed User is validating "Conceirge Key" Request Number for "Book" for <TestCase>
