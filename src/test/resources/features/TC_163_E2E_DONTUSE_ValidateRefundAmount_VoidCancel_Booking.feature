...
Feature: Void Booking

	Do a Void booking and perform all the validations
...
, Payment should be done using Don’t use flow
, Refundable amount should be less than Direct payment amount
