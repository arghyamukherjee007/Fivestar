@Regression @P1Scripts @TC_145CancelCustomerBooking
Feature: Cancel Booking - Five Star

	Do a Five Star cancel booking and perform all the validations
	    
  @TC_145CancelCustomerBookingScenario1
  Scenario Outline:  Booking should contain less than 7 days and greater than 7 days airports and SR emails should not be delivered already,
  Override amount should be entered in cancel taskflow
