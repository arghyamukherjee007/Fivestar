@Regression @P1Scripts @TC_117EditCustomerBooking
Feature: Edit Transportation Info - Five Star 

	Do the transportation update and validate the remarks and SR email
	
  @TC_117EditCustomerBookingScenario1
  Scenario Outline: Booking should contain more than four airports selected with service date as combination of less than 7 days and more than 7 days,Transportation update should be done for all the airports,Send Email flag in final screen should be unchecked
    ...
    Then User is navigating to "EDIT TRANSPORTATION DETAILS" Screen
