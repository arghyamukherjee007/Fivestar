@Regression @P1Scripts @TC_011FivestarBooking
Feature: FiveStar Booking
  Do a Five Star booking and perform all the validations Ticketed PNR with one AADV customers should be given as input

  @TC_011FiveStarBookingScenario1
  Scenario Outline: Do a Five Star booking and perform all the validations Ticketed PNR with one AADV customers should be given as input
