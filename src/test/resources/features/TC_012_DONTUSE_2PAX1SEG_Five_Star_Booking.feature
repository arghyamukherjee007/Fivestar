@Regression @P1Scripts @TC_012FivestarBooking
Feature: FiveStar Booking
  Do a Five Star booking and perform all the validations Ticketed PNR with more than one AADV customers should be given as input

  @TC_012FiveStarBookingScenario1
  Scenario Outline: Do a Five Star booking and perform all the validations Ticketed PNR with more than one AADV customers should be given as input

    #Given the required inputs below for "2Pax1Seg" PNR Creation for <TestCase>
