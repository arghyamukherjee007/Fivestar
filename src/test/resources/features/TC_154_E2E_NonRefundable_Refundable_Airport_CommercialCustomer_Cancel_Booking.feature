@Regression @P1Scripts @TC_154CancelCustomerBooking
Feature: Cancel Booking - Commercial Customer

	Do a Commercial Customer cancel booking and perform all the validations
	    
  @TC_154CancelCustomerBookingScenario1
